  ...
  public boolean onCommand(CommandSender sender, Command cmd, String cmdLabel, String[] args)
  {
    if ((sender instanceof Player))
    {
      if (cmd.getName().equalsIgnoreCase("fly"))
      {
        ...
        {
          player.sendMessage(API.NomeServer + "§cVoce nao possue permissao para isso!");
          return true;
        }
        if (args.length == 0) {
          ...
          (sender.hasPermission("kitpvp.darfly")))
        {
          ...
          if (!player2.getAllowFlight())
          {
            ...
            Bukkit.broadcast(API.NomeServer + "§a" + player.getName() + ChatColor.GRAY + " habilitou o fly de " + player2.getName(), "kitpvp.staff");
          }
          else
          {
            ...
            Bukkit.broadcast(API.NomeServer + "§a" + player.getName() + ChatColor.GRAY + " desabilitou o fly de " + player2.getName(), "kitpvp.staff");
          }
        }
      }
    }
