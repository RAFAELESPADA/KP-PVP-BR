  ...
  implements CommandExecutor
{
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
  {
    ...
    {
    	p.sendMessage(ChatColor.YELLOW + "\u274C" + ChatColor.AQUA + " INFORMAÇOES DOS RANKS " + ChatColor.YELLOW + "\u274C");
    	p.sendMessage(ChatColor.WHITE + "\u279C No Nosso Servidor possuímos sistema de níveis");
