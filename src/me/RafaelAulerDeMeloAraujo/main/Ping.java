  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
  {
    if (args.length > 0)
    {
      ...
      if (p != null)
      {
        ...
        sender.sendMessage("§a§lPING: §aO ping de " + p.getName() + " é de: " + ChatColor.RED + ping + "ms");
      }
      else
      {
    ...
    if ((sender instanceof Player))
    {
      ...
      sender.sendMessage("§a§lPING: Seu Ping é de : " + ChatColor.RED + ping + "ms");
    }
    else
    {
      sender.sendMessage("§a§lPING: §aSeu Ping é de: " + ChatColor.RED + "0ms");
    }
    return true;
  }
}
